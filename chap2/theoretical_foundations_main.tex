...
\begin{figure}
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt, color=white]
        \centering
        \subfigure[a]{\includegraphics[width=0.4\textwidth]{chap3/images/air-bending}}
        \subfigure[b]{\includegraphics[width=0.4\textwidth]{chap3/images/v-bending}}
...
One of the main goals of \ac{ML} is to minimize the generalization error to create a model that performs well
on new, unseen data.
