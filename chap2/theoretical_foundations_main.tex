...
% Pado: More detail, please! What exactly are its parameters? What are the non-linearly
% affected
% measures?
...
% “Recently, there has been an increasing use of machine learning (ML) algorithms in
% various
% applications related to sheet metal forming to improve decision making and achieve
% cost-effective, defect-free, and optimal manufacturing quality [17,18]. The ML
% algorithms can
% be divided mainly in three categories: supervised learning, unsupervised learning
% [19], and
% reinforcement learning [20]. Generally, supervised learning is preferred and is used in
% classification or regression problems, encompassing support vector machine (SVM)
% algorithms,
% naive Bayes classifier, decision tree, the K-nearest neighbor (KNN) algorithm and
% artificial
% neural networks (ANN).”
