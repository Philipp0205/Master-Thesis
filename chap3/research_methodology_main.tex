...
software systems and its components like ISO/IEC 25010.
\cite[]{siebert_constructionqualitymodel_} noted, that such standards can not applied directly to
ML and therefore need to be adapted. Therefore they re-interpreted and extended these existing
quality models to the ML context. \cite[p. 1]{siebert_constructionqualitymodel_}
In order to define the Design Principles for the artifacts in this work, the considerations of
\cite[]{siebert_constructionqualitymodel_} are used. This enables a systematic process in order
to assess the quality of the developed artifacts.
