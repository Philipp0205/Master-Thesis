...
Random forest \cite[]{breiman_randomforests_2001}is a type of ensemble learning algorithm in which multiple decision trees, referred to as "weak learners," are trained and combined to produce a more accurate and stable prediction, known as a "strong learner." \cite[p. 24]{awad_efficientlearningmachines_2015}


Random forests are usually used for classification problems, but they can also be used for regression problems. \cite[p. 25]{breiman_randomforests_2001}
...
\subsubsection*{Tuning Random Forest Regression}
