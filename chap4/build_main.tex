...
~\cite[p. 49--51]{zhou2021machine}.
It suggests, that a model can accurately capture the underlying patterns in the data
without overfitting or underfitting~\cite[p. 49--51]{zhou2021machine}.
...
\cite{muller2016introduction} define interpretability as ``how well a human could understand the decisions in the
given context''
Also the author add, that it is also important to understand ``why'' the model has this performance
