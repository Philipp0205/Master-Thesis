...
However, when trained on 50\% of the data, the \ac{MLP}  and \ac{GBT} models start to perform better than the
other models.
...
%    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
%        \centering
%        \includegraphics[width=0.9\textwidth]{missing_values_plot}
%        \caption{Comparison of performance on less data}
