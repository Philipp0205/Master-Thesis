...
\begin{figure}[h]
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        \centering
        \includegraphics[trim=left botm right top, width=0.9\textwidth]{cross_validation}
...
\begin{figure}[H]
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        ...
        \hfill
        \begin{subfigure}{0.5\textwidth}
            \includegraphics[width=\textwidth]{performance_30_2}
            \caption{V: 30, t: 2}
...
\begin{figure}
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        ...
        \hfill
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[width=\textwidth]{partial_dependence_MLP}
            \caption{MLP}
...
\begin{figure}[H]
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        \centering
        \includegraphics[width=0.9\textwidth]{dpd_distance_die_opening}
    \end{tcolorbox}
