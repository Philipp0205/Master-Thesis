...
%It is crucial to evaluate the robustness of the model by testing it with missing
%$Vt$-pairs to ensure its performance handling incomplete data.
...
The alternative approach chosen is to use regular cross-validation with an increasing
number of folds.
