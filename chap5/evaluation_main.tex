...
was generated in a controlled environment does not contain many data quality issues.
...
\begin{table}[H]
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        ...
        \begin{tabular}{llll}
            \toprule
            \thead{\textbf{Model Name}} & {\thead{\textbf{Missing $Vt$-combinations} \\
            \unit{loa}}} & \thead{  ßVariance of CV} \\
