...
%Introduction
%Briefly restate the research objectives and hypotheses
%Provide an overview of the methods used (e.g., data collection, ML model development, and evaluation)
...
%Summarize the collected real-world air-bending dataset, including the number of samples, features, and target
%variable (spring back)
%Describe any preprocessing steps applied to the data (e.g., normalization, feature engineering, or data imputation)
The data was collected using the air-bending process and the spring back was measured using the output data of the
press brake.
...
%Key Findings
%Summarize the most important findings related to the tested hypotheses
%Identify the best-performing ML model(s) based on the evaluation criteria
%Highlight any novel insights or contributions made by the research
...
\textbf{Feature selection:} This study had a limited number of input featues (punch penetration, die opening and
...
%As suggested by \cite{dib_singleensembleclassifiers_2020}, the use of more complex ensemble models could further
%improve the generalization performance of the models.
