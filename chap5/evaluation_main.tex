...
\begin{figure}[H]
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        ...
        \begin{subfigure}{0.4\textwidth}
            \includegraphics[width=\textwidth]{missing_values_plot.png}
            \caption{}
            \label{fig:first}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.4\textwidth}
            \includegraphics[width=\textwidth]{variance_missing_values.png}
            \caption{}
            \label{fig:second}
        \end{subfigure}
        \hfill
...
\begin{figure}[H]
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        \centering
        \includegraphics[width=0.9\textwidth]{rf_feature_importances}
    \end{tcolorbox}
...
thickness of the metal sheet results in a lower spring back. The effect of the die opening is
less significant than the other two features, but there is still a noticeable increase in spring
...
\begin{figure}
    \begin{tcolorbox}[arc=0pt,boxrule=0.5pt]
        ...
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[width=\textwidth]{partial_dependence_SVM}
            \caption{Partial dependence plot SVM}
            \label{fig:feature_impoartances_rf}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.45\textwidth}
            \includegraphics[]{partial_dependence_MLP}
            \caption{Partial dependence plot MLP}
...
alternative models as permutation feaure importance and SHAP values are used to gain further
information.
