...
\documentclass[parskip=full]{um}  % custom University of Malta project/dissertation/thesis
...
\title{Machine Learning for \\ the Prediction of Bending Parameters}  % use \\ here otherwise you get a justified title
...
\graphicspath{{./images/}{./chap1/images/}{./chap2/images/}{./chap3/images/}{./chap4/images/}{./chap5/images}}   % Paths where to look for images, if defined "images" must always be there as it holds the images in-use by the template.
...
\begin{document}
    ...
    % Do not indent paragraphs \setlength{\parindent}{0pt}
    \parskip = 6pt
...
%%	\part{Your First Part} %% PhDs may require this parts idea as well.
    ...
    \input{chap2/theoretical_foundations_main}
    \input{chap3/research_methodology_main}
    \input{chap4/build_main}
